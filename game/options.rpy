...
define config.name = _("DIGITAL IMMORTALITY")
...
define config.main_menu_music = "audio/Matrix Relax.mp3"
define config.game_menu_music = "audio/Matrix Relax.mp3"
...
define config.save_directory = "Novel-1666280037"
